...
class TestActionCache:
    ...
    def test_record_action_basic(self, mock_time):
        ...
        count = self.cache.record_action(
            guild_id=1, user_id=2, action_type="test", timeframe=10
        )
        assert count == 1
    ...
    def test_clear_user(self, mock_time):
        ...
        self.cache.record_action(
            guild_id=1, user_id=3, action_type="test", timeframe=10
        )
    ...
    def test_clear_guild(self, mock_time):
        ...
        self.cache.record_action(
            guild_id=2, user_id=2, action_type="test", timeframe=10
        )
