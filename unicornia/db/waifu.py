class WaifuRepository:
    ...
    async def get_waifu_info(self, waifu_id: int) -> tuple | None:
    ...
    async def gift_waifu_transaction(
        self,
        giver_id: int,
        waifu_id: int,
        gift_name: str,
    ...
    async def get_waifu_owner(self, waifu_id: int) -> int | None:
        """Get waifu owner.
    ...
    async def get_waifu_affinity(self, waifu_id: int) -> int | None:
        """Get waifu affinity.
