class ClubRepository:
    ...
    async def get_club(self, club_id: int) -> tuple | None:
        """Get club by ID.
    ...
    async def get_club_by_name(self, name: str) -> tuple | None:
        """Get club by name.
    ...
    async def get_club_by_member(self, user_id: int) -> tuple | None:
