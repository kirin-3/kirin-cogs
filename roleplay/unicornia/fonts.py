...
def get_text_size(text: str, font: ImageFont.ImageFont | ImageFont.FreeTypeFont):
...
def calculate_font_size(image_size: tuple[int, int], text: str, base_font_size: int = 28) -> int:
    ...
    suggested_font_size = int(width // text_length_factor)
